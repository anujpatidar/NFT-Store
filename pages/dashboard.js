...
const Dashboard = () => {
  ...
  return (
    <div className="relative ">
      {" "}
      <Head>
        <title>Dashboard || NFT Store</title>
      ...
      {!nfts.length ? (
        <div className="w-full h-50 flex flex-col items-center justify-center font-body">
          ...
          <div className="relative  overflow-hidden">
            <h1 className="text-center mt-28 ">Hot NFTs</h1>
          <section className="max-w-[1200px] my-8 mx-auto grid grid-cols-3 md:grid-cols-2 gap-4 font-body  overflow-hidden top-7 md:gap-5 medium md:px-5 sm:grid-cols-1 sm:h-full relative justify-center items-center ">
            {nfts?.map((nft, i) => (
              <div key={i} className="w-full h-[536px] sm:h-full ssm:h-max">
                <div
                  className="w-full h-full ssm:h-max bg-[#333]/60 rounded-2xl flex flex-col p-6 sm:h-max cursor-pointer"
                  onClick={() => {
                    router.push({
                ...
                >
                  <div className="relative transition duration-150 ease-in-out delay-150">
                    ...
                    />
                    <div className="absolute top-0 left-0  bg-[#ccc]/10  backdrop-blur-xl w-full h-full z-[20] rounded-2xl opacity-0 hover:opacity-100">
                      <div className="flex items-center justify-center h-full ">
                        <button
                          className="bg-[#000] outline-none border-none py-3 px-5 rounded-xl font-body cursor-pointer transition duration-250 ease-in-out hover:scale-125 hover:drop-shadow-xl hover:shadow-sky-600 w-auto "
                          onClick={() => {
                            router.push({
                              pathname: "/nft-details",
                              query: nft,
                    ...
                    <div className="h-[56px] flex justify-between">
                      <div className="flex flex-row gap-2">
                        <div>
                          ...
                          <h4 className="my-0 ssm:text-sm text-transparent font-bold bg-clip-text bg-gradient-to-r from-white to-[#333]">
